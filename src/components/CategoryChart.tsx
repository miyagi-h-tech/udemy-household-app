...
function CategoryChart({ monthlyTransactions, isLoading }: CategoryChartProps) {
  const [selectedType, setSelectedType] = useState<TransactionType>("expense");

  const handleTypeChange = (e: SelectChangeEvent<"income" | "expense">) => {
  ...
  return (
    <Box>
      {/* <TextField id={"select-type"} label={} select fullWidth value={selectedType}
