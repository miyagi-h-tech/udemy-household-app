  ...
  return (
    <Box
      sx={{
        position: "fixed",
        top: 64,
        right: isEntryDrowerOpen ? formWidth : "-2%", // フォームの位置を調整
        width: formWidth,
        height: "100%",
    ...
    >
      ...
      <Box component={"form"}>
        <Stack spacing={2}>
          ...
          />
          {/* 保存ボタン */}
          <Button type="submit" variant="contained" color={currnetType === "income" ? "primary" : "error"} fullWidth>
            保存
          </Button>
        </Stack>
      </Box>
